...
\begin{document}
\section{Experiment 1: Policy Gradient}
\begin{figure}[H]
    \centering
...
\section{Experiment 2: Neural Network Baseline}
...
\end{figure}
\subsection{Baseline Learning Rate Comparison}
\begin{figure}[H]
...
\section{Experiment 3: Generalized Advantage Estimation}
\subsection{Return Curves} 
    \begin{figure}[H]
        \centering
...
\subsection{Analysis Lambda}
    $\lambda = 0$ correspond to $\hat{A}(s_t, a_t) = r(s_t, a_t) + \gamma \hat{V}(s_{t+1}) - \hat{A}(s_t)$, 
...
\section{Experiment 4: Hyperparameters and Sample Efficiency}
\subsection{4.1 Hyperparameters}
\begin{table}[H]
    \centering
